...
if(isset($_POST['insert_product'])){
    ...
    if($product_title=='' or $description=='' or $product_category='' or $product_price=='' or $product_image==''){
        ...
        //insert query
        $insert_products="insert into `products` (product_title,product_description,category_id,product_image,product_price,date,status) values ('$product_title','$description','$product_category','$product_image','$product_price',NOW(),'$product_status')";
...
<body class="bg-dark">
    ...
    <!-- form -->
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <!-- submit -->
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" name="insert_product" class="btn btn-light mb-3 px-3" value="Insert Product">
            </div>   
